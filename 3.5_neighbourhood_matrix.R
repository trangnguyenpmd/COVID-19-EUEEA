...
# --------------------------------------------------------------------#
aa <- st_make_valid(map_europe) 
row.names(aa) <- EU30_countries
neighbor_original <- nbOrder(poly2adjmat(aa), maxlag = Inf)
...
# --------------------------------------------------------------------#
# ====== ADJUSTED NEIGHBOURHOOD MATRIX ========== (for powerlaw model)
# --------------------------------------------------------------------#
